...
public class IspisDostupnihDatuma extends HttpServlet  {
	...
	public void service (HttpServletRequest req, HttpServletResponse res) throws IOException {
		...
		Map <Integer, Integer> slobodniDatumi = new HashMap();
		...
		*/
		...
		objectMapper.writeValue(stringWriter, slobodniDatumi );
